...
5. Rename the extracted folder from `super-cloud-main` to `super-cloud`.
6. Copy the renamed `super-cloud` folder into your agent's skills directory.
...
This repository is the `super-cloud` skill. Keep the full `super-cloud` folder together when installing it.
